...
(() => {
  ...
  function designThumb(id) {
    const T = {
      ...
      onyx: "<rect width='100' height='74' fill='#fff'/><rect x='0' y='0' width='100' height='31' fill='#17181d'/><rect x='6' y='5' width='88' height='21' fill='none' stroke='rgba(255,255,255,0.28)' stroke-width='1'/><rect x='45' y='2.5' width='10' height='1.5' fill='#9aa0ad'/><rect x='41' y='9' width='18' height='8' rx='1' fill='#fff'/><rect x='44' y='20' width='12' height='2' fill='#c7cbd4'/><rect x='47' y='24' width='6' height='1.5' fill='#8b93a4'/><rect x='6' y='37' width='3' height='6' fill='#5b6472'/><rect x='12' y='38' width='26' height='4' fill='#2b303c'/><rect x='6' y='45' width='88' height='1' fill='#d6d9e0'/><g fill='#e7e9ef'><rect x='6' y='49' width='26' height='18' rx='1'/><rect x='37' y='49' width='26' height='18' rx='1'/><rect x='68' y='49' width='26' height='18' rx='1'/></g>",
      atelier: "<rect width='100' height='74' fill='#f4f2ec'/><rect x='6' y='6.5' width='88' height='1' fill='#2b303c'/><rect x='6' y='9' width='88' height='1' fill='#2b303c'/><rect x='33' y='14' width='34' height='8' rx='1' fill='#9aa0ad'/><rect x='40' y='24' width='20' height='3' rx='1' fill='#5b6472'/><rect x='6' y='30' width='88' height='1' fill='#5b6472'/><g fill='#fff' stroke='#d3cec1' stroke-width='1'><rect x='6' y='35' width='26' height='31'/><rect x='37' y='35' width='26' height='31'/><rect x='68' y='35' width='26' height='31'/></g><g fill='#e7e3da' stroke='#e0dbcf' stroke-width='.6'><rect x='9' y='38' width='20' height='16'/><rect x='40' y='38' width='20' height='16'/><rect x='71' y='38' width='20' height='16'/></g><g fill='#c7cbd4'><rect x='9' y='57' width='13' height='2.5'/><rect x='40' y='57' width='13' height='2.5'/><rect x='71' y='57' width='13' height='2.5'/></g>",
    };
  ...
  function productCardHTML(p, selected, showEdit, drag) {
    ...
    return `<div class="pcard ${selected ? 'selected' : ''}" data-id="${p.id}">
      <div class="check">${icon('check')}</div>${editBtn}${dragBtn}
      ${img}
      <div class="pbody">
  ...
  const SHEET_DESIGNS = {
    ...
    onyx:      (c) => `<header class="hero"><span class="hero-frame"></span><div class="hero-logo">${s_logo(c)}</div><div class="hero-head"><h1 class="hero-title">${c.title}</h1><span class="hero-rule"></span></div></header>${s_body(c)}${s_foot(c)}`,
    atelier:   (c) => `<header class="hero"><span class="hero-rule-top"></span><div class="hero-logo">${s_logo(c)}</div><div class="hero-head"><h1 class="hero-title">${c.title}</h1></div><span class="hero-rule-bot"></span></header>${s_body(c)}${s_foot(c)}`,
  };
