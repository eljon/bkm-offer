...
(() => {
  ...
  function designThumb(id) {
    const T = {
      ...
      datasheet: "<rect width='100' height='74' fill='#fff'/><rect x='6' y='7' width='15' height='10' rx='1' fill='#e7e9ef'/><rect x='55' y='6' width='39' height='14' rx='0.5' fill='none' stroke='#9aa0ad' stroke-width='1'/><rect x='6' y='24' width='88' height='1.4' fill='#2b303c'/><rect x='6' y='30' width='40' height='4' rx='0.5' fill='#9aa0ad'/><rect x='6' y='36' width='88' height='1' fill='#e4e6ec'/><g fill='none' stroke='#dcdfe6' stroke-width='1'><rect x='6' y='40' width='26' height='26'/><rect x='37' y='40' width='26' height='26'/><rect x='68' y='40' width='26' height='26'/></g>",
    };
  ...
  const SHEET_DESIGNS = {
    ...
    datasheet: (c) => `<header class="hero"><div class="hero-logo">${s_logo(c)}</div><div class="hero-block"><h1 class="hero-title">${c.title}</h1></div></header>${s_body(c)}${s_foot(c)}`,
  };
