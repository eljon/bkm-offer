...
(() => {
  ...
  // Canva-esque offer themes. c1 = primary/accent, c2 = deep shade, bg = sheet
  // background, ink = hero text color (default #fff), eyebrow = kicker label.
  const OFFER_THEMES = [
    { id: 'crimson',  name: 'Crimson',  c1: '#e11d48', c2: '#7a1030', bg: '#f4f6fb', eyebrow: '★ ONHAND STOCK ★' },
    { id: 'ocean',    name: 'Ocean',    c1: '#0ea5e9', c2: '#075985', bg: '#eff8ff', eyebrow: '★ NEW ARRIVALS ★' },
    { id: 'sunset',   name: 'Sunset',   c1: '#f97316', c2: '#be123c', bg: '#fff7ed', eyebrow: '☀ HOT DEALS ☀' },
    { id: 'forest',   name: 'Forest',   c1: '#16a34a', c2: '#14532d', bg: '#f0fdf4', eyebrow: '★ FRESH STOCK ★' },
    { id: 'grape',    name: 'Grape',    c1: '#9333ea', c2: '#4c1d95', bg: '#faf5ff', eyebrow: '★ LIMITED EDITION ★' },
    { id: 'teal',     name: 'Teal',     c1: '#14b8a6', c2: '#0f766e', bg: '#f0fdfa', eyebrow: '★ BEST VALUE ★' },
    { id: 'coral',    name: 'Coral',    c1: '#ff5a5f', c2: '#c92a2a', bg: '#fff5f5', eyebrow: '★ FLASH SALE ★' },
    { id: 'slate',    name: 'Slate',    c1: '#334155', c2: '#0f172a', bg: '#f8fafc', eyebrow: '★ WHOLESALE ★' },
    { id: 'midnight', name: 'Midnight', c1: '#818cf8', c2: '#312e81', bg: '#0f172a', ink: '#fff', eyebrow: '★ EXCLUSIVE ★' },
    { id: 'gold',     name: 'Gold',     c1: '#d4af37', c2: '#7c5e10', bg: '#141109', ink: '#fff', eyebrow: '★ PREMIUM ★' },
  ];
  ...
  function resolveTheme(offer) {
    ...
    if (acc) {
      ...
      if (m) return m;
      return { id: 'custom', name: 'Custom', c1: acc, c2: shade(acc, -0.34), bg: '#f4f6fb', eyebrow: '★ ONHAND STOCK ★' };
    }
  ...
  function buildSheet(offer) {
    ...
    const accent = theme.c1;
    const dark = theme.c2;
    const bg = theme.bg || '#f4f6fb';
    const ink = theme.ink || '#fff';
    const eyebrow = theme.eyebrow || '★ ONHAND STOCK ★';
    ...
    return `<div class="sheet" style="--accent:${accent};--sheet-bg:${bg}">
      <div class="hero" style="background:linear-gradient(135deg, ${accent} 0%, ${dark} 100%)">
        ...
        <div class="hero-text">
          <span class="hero-eyebrow" style="color:${accent}">${esc(eyebrow)}</span>
          <h1 class="hero-title" style="color:${ink}">${title}</h1>
        </div>
